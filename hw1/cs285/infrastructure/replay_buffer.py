...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        sample_indices = np.random.permutation(len(self.obs))[:batch_size]
        return (self.obs[sample_indices], self.acs[sample_indices], self.rews[sample_indices], self.next_obs[sample_indices], self.terminals[sample_indices])
